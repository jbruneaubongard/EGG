...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=int, 
        default=0,
        help="Weight of the bridge interaction (exp_2)",
        )
    parser.add_argument(
        "--save_data",
        type=bool,
...
if __name__ == "__main__":
    ...
    lists_of_agents, dict_origin_of_agents = merge_communities_from_saved_agents(opts, folder_saved_data)

    for idx_graph in range(opts.nb_agents*(opts.nb_agents-1)//2):
        ...
        features_to_save = ['root', 'nb_agents', 'type_exp', 'subtype_exp', 
                            'w_central_sender', 'w_central_receiver', 'w_noncentral', 'bridge_w',
