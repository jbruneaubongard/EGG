...
from egg.zoo.pop_signal_game.interaction import Interaction
        ...
        with torch.no_grad():
            for batch_id, batch in enumerate(validation_data):
                ...
                optimized_loss, interaction = self.game(
                    ...
                    epoch=epoch, 
                    turn=batch_id, 
                    receiver_input=batch.receiver_input, 
                    aux_input=batch.aux_input
                )
                if (
    ...
    def train(self, n_epochs, path):
        ...
        for epoch in range(self.start_epoch, n_epochs):
            ...
            if self.opt.save_data:
                train_interaction.save_to_json(path, "epoch=" + str(epoch))
            ...
            if (
                ...
                validation_loss, validation_interaction = self.eval(epoch=epoch)
